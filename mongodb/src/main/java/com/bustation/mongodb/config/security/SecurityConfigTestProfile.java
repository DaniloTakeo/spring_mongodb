...
/**
 * Classe de configuração da segurança da aplicação em ambiente de teste.
 *
...
@Profile("test")
public class SecurityConfigTestProfile {
     ...
     *
     * <p>Desabilita o CSRF, permite acesso público a todos os endpoints
